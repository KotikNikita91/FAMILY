...
form.addEventListener('submit', function(e) {
    ...
    fetch(SCRIPT_URL, {
        method: 'POST',
        // Важно: Apps Script ожидает данные в определенном виде.
        // Мы настроили doPost для приема 'application/json'.
        // Альтернативно можно использовать 'application/x-www-form-urlencoded'
        // или 'text/plain', но тогда нужно менять парсинг в doPost.
        // mode: 'no-cors', // Раскомментируй, если возникают проблемы с CORS, но тогда не получишь ответ!
        headers: {
           'Content-Type': 'application/json', // Указываем, что шлем JSON
            // ВАЖНО: Для doPost в Apps Script обычно не нужен 'Accept'
        },
        // mode: 'cors', // По умолчанию, но могут быть проблемы, если скрипт не настроен правильно
